...
**Data:** 2026-09-22
**Status:** em revisão; **não aprovada integralmente**. Incorpora as decisões parciais de 2026-09-22 (B2, parte de B3, DS2, DS3, perfil Administrador).
**Rascunho anterior:** `docs/historico/v2.0-planejamento/eag-compass-constituicao-v2.0-rascunho1.md`.
