...
**Data:** 2026-09-22
**Status:** em revisão; **não aprovada integralmente**. Incorpora as decisões de 2026-09-22 (B2, parte de B3, DS1, DS2, DS3, perfil Administrador) e a diretriz "todo trabalho de prospecção obedece à `/prospeccao-vendas`" (T12 rev. 3).
**Rascunhos anteriores:** `docs/historico/v2.0-planejamento/eag-compass-constituicao-v2.0-rascunho1.md`, `…-rascunho2.md` e `…-rascunho3.md`.
...
### P16 — Compradores, não fornecedores — **Novo (rascunho 4: parte sobre porte e traders pendente de K1/K3)**

**Princípio:** o Compass procura compradores. A cidade do fornecedor conhecido é só referência logística. Consumidores finais têm prioridade. Porte-alvo e elegibilidade de traders para abordagem seguem a decisão de Rogério sobre K1 e K3 (Spec §6.0.1). Até lá: todos visíveis e classificados; ficha só para indústrias usuárias de porte médio ou média-mais (Spec R14.3).

**Como auditar:**

- [ ] Nenhuma funcionalidade pesquisa ou sugere fornecedores (AT16).
- [ ] Nenhum bloqueio de **visualização/classificação** por perfil trader; o critério 7 do gate segue R2.4 (AT12).
- [ ] Priorização verificável (AT19, AT59).
...
**Relação com os demais princípios:** a skill governa o **método**; P7, P11–P15 e P18 governam os **controles** (aprovação, supressão, LGPD, compliance, veracidade, integração comprovada). Os dois se somam. Quando colidem literalmente, vale o mais restritivo até decisão de Rogério registrada na Spec (K1–K6). Descumprir um inviolável da skill exige exceção registrada nesta Constituição.
