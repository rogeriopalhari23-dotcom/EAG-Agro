...
**Status:** em andamento. **Aprovadas por Rogério em 2026-09-22: G1, G3, G4, G5.** Pendentes: G2 (quem administra a conta Cloudflare do `eagagro.com`), G6, G7.
...
**Registro:** G1 (Workers Paid), G3 (envio E1, exceção registrada na Constituição), G4 (recebimento R1) e G5 (Access + `ctx.access`) **aprovadas em 2026-09-22**. G2, G6 e G7 continuam abertas.
