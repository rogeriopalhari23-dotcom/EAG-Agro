...
**Data:** 2026-09-22
**Status:** em revisão; **não aprovada integralmente**. Decisões de Rogério em 2026-09-22 incorporadas: perfil Administrador, B2, B3 em parte, DS1 (DS1-b não, DS1-c sim), DS2 e DS3. Fase 3 não encerrada.
**Rascunhos anteriores:** `docs/historico/v2.0-planejamento/eag-compass-spec-v2.0-rascunho1.md` e `…-rascunho2.md`.
**Versão substituída:** Especificação v1.3 (2026-09-21), arquivada sem alteração em `docs/historico/v1.3/eag-compass-spec-v1.3.md`.
**Constituição associada:** `docs/eag-compass-constituicao.md` (v2.0, rascunho 3).
...
| T12 | `/prospeccao-vendas` | Leitura relatada da v1.0 (SHA-256 `94544246…acd0`); regras especificadas em R17. **Em 2026-09-22 às 20:10 a skill foi substituída** (SHA-256 `33bd093f…9dd8`, 214 linhas, agora com `references/`, `assets/` e `evals/`). A versão nova não foi lida nem incorporada. Gatilho da §7 acionado. | Antes da primeira ficha do piloto |
...
- **R17.1:** Cada texto gerado DEVE registrar o SHA-256 do `SKILL.md` efetivamente lido e incorporado, a versão das adaptações Compass e a versão do gerador. PV1–PV8 e A1–A11 foram derivados da v1.0 (`94544246…acd0`).
- **R17.8:** SE o SHA-256 da skill disponível for diferente do incorporado, ENTÃO o sistema DEVE impedir a geração de novos textos até nova leitura registrada (T12) e revisão de PV/A. Textos já aprovados não são reescritos (R17.5). *Situação em 2026-09-22: condição ativa — skill substituída às 20:10, SHA-256 `33bd093f…9dd8`.*
...
| **T12 — nova versão da skill** | Ler e registrar a `/prospeccao-vendas` substituída em 2026-09-22 20:10 (`33bd093f…9dd8`) e revisar PV1–PV8 e A1–A11 | Geração de textos bloqueada (R17.8); PV/A atuais valem só para a v1.0 | Primeira ficha do piloto. Não bloqueia o restante da Spec. |
...
| `/prospeccao-vendas` v1.0 (SHA-256 `94544246…acd0`) | Skill atualizada — **acionado em 2026-09-22 20:10** (`33bd093f…9dd8`) | Nova leitura T12, PV1–PV8, A1–A11, R17; geração bloqueada até lá (R17.8) |
