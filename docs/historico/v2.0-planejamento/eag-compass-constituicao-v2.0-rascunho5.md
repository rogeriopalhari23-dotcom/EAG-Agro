...
**Data:** 2026-09-22
**Status:** em revisão; **não aprovada integralmente**. Incorpora as decisões de 2026-09-22 (B2, parte de B3, DS1, DS2, DS3, perfil Administrador) e a diretriz "todo trabalho de prospecção obedece à `/prospeccao-vendas`" (T12 rev. 3), e K1–K6 decididos conforme recomendação.
...
**Spec associada:** `docs/eag-compass-spec.md` (v2.0, rascunho 5).
