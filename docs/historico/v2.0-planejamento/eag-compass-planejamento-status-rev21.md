...
**Iniciado:** 2026-09-22
**Atualização:** 2026-09-23 — revisão documental 21 do status — Fases 3–5 concluídas; **Fase 6 em andamento: Planos 1 (Fundação) e 2 (Piloto Nacional) escritos**
**Revisões anteriores:** rev. 4 a 20 arquivadas em `docs/historico/v2.0-planejamento/`.
**Método:** `/planejar`
...
| **6. Plano** | **Em andamento (iniciada em 2026-09-22 com autorização de Rogério).** Dividida em 3 planos: **Plano 1 — Fundação (Etapa 0) escrito** (12 tarefas); **Plano 2 — Piloto Nacional (Etapa 1) escrito** (18 tarefas; migrações 0006–0008; primeiro e-mail externo só após o roteiro de T1 da tarefa 17 e liberação por escrito de Rogério); Plano 3 — Internacional a escrever (migrações 0009+). Plano 2 ainda **não revisado por Rogério**. Linha de base medida: 14/14 testes; `npm run check` falha no Windows; migrações 0001–0002 aplicadas localmente. Ajuste da G5: identidade pelo JWT do Access (ctx.access não chega com Static Assets) | `docs/superpowers/plans/2026-09-22-eag-compass-fundacao.md` (`30dc72a5…`), `docs/superpowers/plans/2026-09-22-eag-compass-piloto-nacional.md` (`8080a03e…`) |
| 7–9 | Pendentes | — |
