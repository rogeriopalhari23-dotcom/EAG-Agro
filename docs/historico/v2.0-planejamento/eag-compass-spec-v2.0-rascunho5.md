...
**Versão:** 2.0 — rascunho 5 da Fase 3
**Data:** 2026-09-22
**Status:** em revisão; **não aprovada integralmente**. Decisões de Rogério em 2026-09-22 incorporadas: perfil Administrador, B2, B3 em parte, DS1 (DS1-b não, DS1-c sim), DS2 e DS3; nova leitura T12 (rev. 3) e diretriz "todo trabalho de prospecção obedece à `/prospeccao-vendas`"; K1–K6 decididos conforme recomendação (2026-09-22). Fase 3 não encerrada.
...
**Constituição associada:** `docs/eag-compass-constituicao.md` (v2.0, rascunho 5).
