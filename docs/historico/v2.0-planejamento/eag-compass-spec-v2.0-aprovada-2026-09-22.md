...
**Versão:** 2.0
**Data:** 2026-09-22
**Status:** **APROVADA por Rogério Palhari (Administrador) em 2026-09-22.** Fase 3 encerrada. Conteúdo idêntico ao rascunho 5 (`historico/v2.0-planejamento/…-rascunho5.md`), exceto estas linhas de controle e a ativação de R17.8. Pendências com regra vigente especificada: B1 e limites de raio (B3).
