...
**Data:** 2026-09-22
**Status:** redigida para revisão; **não aprovada**.
...
- [ ] Busca: parâmetros, fontes, período, cobertura, custo e tempo (R13.5).
...
- [ ] Sem `M` nem tabela específica, Volume e Potencial anual são desconhecidos (R4.3.2).
...
- [ ] Parâmetro sem valor aprovado bloqueia a funcionalidade dependente, sem valor implícito (R7.1.1).
...
- [ ] Mensagem não classificável é tratada como resposta humana (R20.6).
