...
**Iniciado:** 2026-09-22
**Atualização:** 2026-09-22 — revisão documental 16 do status — Fase 3 concluída; **Fase 4 em andamento (partes 1 e 2 entregues)**
**Revisões anteriores:** rev. 4 a 15 arquivadas em `docs/historico/v2.0-planejamento/`.
**Método:** `/planejar`
...
| **4. Pesquisa técnica** | **Em andamento — iniciada em 2026-09-22 com autorização de Rogério.** Partes 1 e 2 entregues. **Aprovadas: G1, G5.** **Limites de raio decididos por Rogério** (5 km e 100–1.500 km em passos de 100; Spec revisão pós-aprovação 1: R11.14, R11.16, R11.17, AT66–AT67). **G2 encerrada** (Compass na conta de Rogério, sem a zona `eagagro.com`). **G3 reaberta** (termos da Hostinger, §12) e **G4 reaberta** (R1 exigia a zona). **Volume de envio aprovado** (5 → 10 → 15 → 20/dia, 15–25 min entre envios, parada automática; Spec revisão pós-aprovação 2: R19.10–R19.12, AT68–AT69). Sem domínio dedicado: envio pela caixa Hostinger e respostas por IMAP. **G3: envio pela Hostinger sem consulta, risco do §12 assumido por Rogério** (Spec revisão pós-aprovação 3: R19.13, premissa, AT70; exceção P19 reativada). **G8–G11 aprovadas.** G7 encerrada (sem acesso ao DNS). Cobertura de skills feita (§10). **Stack consolidada para aprovação (§11).** Pendente: aprovação da stack e G6. | `docs/eag-compass-pesquisa-tecnica.md` |
| 5–9 | Pendentes | — |
