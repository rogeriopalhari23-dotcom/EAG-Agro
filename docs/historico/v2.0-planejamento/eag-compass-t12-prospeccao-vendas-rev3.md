...
**Revisão deste registro:** 3 — nova leitura em 2026-09-22, após a substituição da skill.
...
**Referência de escopo:** `docs/eag-compass-v2-escopo.md` rev. 3; Spec v2.0 rascunho 4.
...
### 3.2 Conflitos que exigem decisão de Rogério

| ID | Skill | Escopo / controle do Compass | Proposta | Regra vigente até decidir |
| --- | --- | --- | --- | --- |
...
| **K3** | I3: ICP = indústrias que **usam** a commodity; trader não é alvo | Decisão 3: traders permanecem elegíveis conforme o contexto | (a) traders visíveis e classificados, fora do ICP de prospecção ativa, com ficha só por exceção registrada por empresa; **ou** (b) exceção permanente na Constituição mantendo a decisão 3 | Traders visíveis, sem ficha |
...
- R17.8: o bloqueio por hash diferente passa a comparar com `33bd093f…9dd8` quando a Spec rascunho 4 for aprovada.
